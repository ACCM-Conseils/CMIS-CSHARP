...
namespace CmisObjectModel.Messaging
{
   ...
   /// </remarks>
    public partial class cmisTypeDefinitionListType : Serialization.XmlSerializable
    {
      ...
      /// <remarks></remarks>
        protected cmisTypeDefinitionListType(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<cmisTypeDefinitionListType, string>> _setter = new Dictionary<string, Action<cmisTypeDefinitionListType, string>>() { }; // _setter
      ...
      /// <remarks></remarks>
        ...
        {
            _types = ReadArray(reader, attributeOverrides, null, Core.Definitions.Types.cmisTypeDefinitionType.CreateInstance);
      ...
      /// <remarks></remarks>
        ...
        {
            WriteArray(writer, attributeOverrides, null, Constants.Namespaces.cmism, _types);
        ...
        protected Core.Definitions.Types.cmisTypeDefinitionType[] _types;
        public virtual Core.Definitions.Types.cmisTypeDefinitionType[] Types
        {
            get
            {
                return _types;
