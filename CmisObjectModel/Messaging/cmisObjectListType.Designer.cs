...
namespace CmisObjectModel.Messaging
{
   ...
   /// </remarks>
    public partial class cmisObjectListType : Serialization.XmlSerializable
    {
      ...
      /// <remarks></remarks>
        protected cmisObjectListType(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<cmisObjectListType, string>> _setter = new Dictionary<string, Action<cmisObjectListType, string>>() { }; // _setter
