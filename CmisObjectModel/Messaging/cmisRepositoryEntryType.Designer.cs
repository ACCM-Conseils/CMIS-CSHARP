...
namespace CmisObjectModel.Messaging
{
   ...
   /// </remarks>
    public partial class cmisRepositoryEntryType : Serialization.XmlSerializable
    {
      ...
      /// <remarks></remarks>
        protected cmisRepositoryEntryType(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<cmisRepositoryEntryType, string>> _setter = new Dictionary<string, Action<cmisRepositoryEntryType, string>>() { }; // _setter
