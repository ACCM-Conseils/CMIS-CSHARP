...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class deleteObject : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected deleteObject(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<deleteObject, string>> _setter = new Dictionary<string, Action<deleteObject, string>>() { }; // _setter
