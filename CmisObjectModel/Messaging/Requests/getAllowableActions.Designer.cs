...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class getAllowableActions : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected getAllowableActions(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<getAllowableActions, string>> _setter = new Dictionary<string, Action<getAllowableActions, string>>() { }; // _setter
