...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class getTypeDefinition : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected getTypeDefinition(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<getTypeDefinition, string>> _setter = new Dictionary<string, Action<getTypeDefinition, string>>() { }; // _setter
