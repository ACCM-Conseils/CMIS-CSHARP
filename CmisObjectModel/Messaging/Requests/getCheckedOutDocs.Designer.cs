...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class getCheckedOutDocs : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected getCheckedOutDocs(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<getCheckedOutDocs, string>> _setter = new Dictionary<string, Action<getCheckedOutDocs, string>>() { }; // _setter
