...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class getObjectOfLatestVersion : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected getObjectOfLatestVersion(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<getObjectOfLatestVersion, string>> _setter = new Dictionary<string, Action<getObjectOfLatestVersion, string>>() { }; // _setter
