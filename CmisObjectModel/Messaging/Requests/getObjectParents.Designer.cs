...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class getObjectParents : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected getObjectParents(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<getObjectParents, string>> _setter = new Dictionary<string, Action<getObjectParents, string>>() { }; // _setter
      ...
      /// <remarks></remarks>
        protected override void WriteXmlCore(sx.XmlWriter writer, Serialization.XmlAttributeOverrides attributeOverrides)
        {
            ...
            if (_includeRelativePathSegment.HasValue)
                WriteElement(writer, attributeOverrides, "includeRelativePathSegment", Constants.Namespaces.cmism, CommonFunctions.Convert(_includeRelativePathSegment));
        ...
        protected bool? _includeRelativePathSegment;
        public virtual bool? IncludeRelativePathSegment
        {
            get
            {
            ...
            set
            {
                if (!_includeRelativePathSegment.Equals(value))
                {
                    var oldValue = _includeRelativePathSegment;
