...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class getRepositories : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected getRepositories(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<getRepositories, string>> _setter = new Dictionary<string, Action<getRepositories, string>>() { }; // _setter
