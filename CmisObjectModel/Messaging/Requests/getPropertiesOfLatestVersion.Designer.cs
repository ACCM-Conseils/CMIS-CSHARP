...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class getPropertiesOfLatestVersion : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected getPropertiesOfLatestVersion(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<getPropertiesOfLatestVersion, string>> _setter = new Dictionary<string, Action<getPropertiesOfLatestVersion, string>>() { }; // _setter
