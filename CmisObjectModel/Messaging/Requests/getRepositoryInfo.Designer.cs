...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class getRepositoryInfo : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected getRepositoryInfo(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<getRepositoryInfo, string>> _setter = new Dictionary<string, Action<getRepositoryInfo, string>>() { }; // _setter
