...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class deleteType : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected deleteType(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<deleteType, string>> _setter = new Dictionary<string, Action<deleteType, string>>() { }; // _setter
