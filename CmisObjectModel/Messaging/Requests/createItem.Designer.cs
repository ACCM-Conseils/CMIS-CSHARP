...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class createItem : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected createItem(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<createItem, string>> _setter = new Dictionary<string, Action<createItem, string>>() { }; // _setter
      ...
      /// <remarks></remarks>
        protected override void ReadXmlCore(sx.XmlReader reader, Serialization.XmlAttributeOverrides attributeOverrides)
        {
            ...
            _extension = Read<cmisExtensionType>(reader, attributeOverrides, "extension", Constants.Namespaces.cmism, GenericXmlSerializableFactory<cmisExtensionType>);
        }
