...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class getObjectByPath : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected getObjectByPath(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<getObjectByPath, string>> _setter = new Dictionary<string, Action<getObjectByPath, string>>() { }; // _setter
