...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class createDocument : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected createDocument(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<createDocument, string>> _setter = new Dictionary<string, Action<createDocument, string>>() { }; // _setter
