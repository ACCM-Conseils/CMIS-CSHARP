...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class getAppliedPolicies : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected getAppliedPolicies(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<getAppliedPolicies, string>> _setter = new Dictionary<string, Action<getAppliedPolicies, string>>() { }; // _setter
