...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class applyPolicy : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected applyPolicy(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<applyPolicy, string>> _setter = new Dictionary<string, Action<applyPolicy, string>>() { }; // _setter
