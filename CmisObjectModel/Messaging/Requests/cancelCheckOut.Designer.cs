...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class cancelCheckOut : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected cancelCheckOut(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<cancelCheckOut, string>> _setter = new Dictionary<string, Action<cancelCheckOut, string>>() { }; // _setter
