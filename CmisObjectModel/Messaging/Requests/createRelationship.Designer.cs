...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class createRelationship : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected createRelationship(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<createRelationship, string>> _setter = new Dictionary<string, Action<createRelationship, string>>() { }; // _setter
