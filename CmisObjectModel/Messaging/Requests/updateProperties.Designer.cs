...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class updateProperties : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected updateProperties(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<updateProperties, string>> _setter = new Dictionary<string, Action<updateProperties, string>>() { }; // _setter
