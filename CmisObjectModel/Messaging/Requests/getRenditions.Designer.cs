...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class getRenditions : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected getRenditions(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<getRenditions, string>> _setter = new Dictionary<string, Action<getRenditions, string>>() { }; // _setter
