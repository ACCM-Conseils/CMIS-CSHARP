...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class createPolicy : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected createPolicy(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<createPolicy, string>> _setter = new Dictionary<string, Action<createPolicy, string>>() { }; // _setter
