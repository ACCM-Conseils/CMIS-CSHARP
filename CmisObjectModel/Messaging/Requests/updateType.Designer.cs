...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class updateType : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected updateType(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<updateType, string>> _setter = new Dictionary<string, Action<updateType, string>>() { }; // _setter
