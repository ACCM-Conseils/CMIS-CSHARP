...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class getFolderTree : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected getFolderTree(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<getFolderTree, string>> _setter = new Dictionary<string, Action<getFolderTree, string>>() { }; // _setter
