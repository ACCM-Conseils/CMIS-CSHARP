...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class addObjectToFolder : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected addObjectToFolder(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<addObjectToFolder, string>> _setter = new Dictionary<string, Action<addObjectToFolder, string>>() { }; // _setter
