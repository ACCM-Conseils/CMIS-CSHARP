...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class createType : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected createType(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<createType, string>> _setter = new Dictionary<string, Action<createType, string>>() { }; // _setter
