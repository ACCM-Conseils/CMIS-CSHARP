...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class setContentStream : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected setContentStream(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<setContentStream, string>> _setter = new Dictionary<string, Action<setContentStream, string>>() { }; // _setter
      ...
      /// <remarks></remarks>
        protected override void WriteXmlCore(sx.XmlWriter writer, Serialization.XmlAttributeOverrides attributeOverrides)
        {
            ...
            if (_overwriteFlag.HasValue)
                WriteElement(writer, attributeOverrides, "overwriteFlag", Constants.Namespaces.cmism, CommonFunctions.Convert(_overwriteFlag));
        ...
        protected bool? _overwriteFlag;
        public virtual bool? OverwriteFlag
        {
            get
            {
            ...
            set
            {
                if (!_overwriteFlag.Equals(value))
                {
                    var oldValue = _overwriteFlag;
