...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class removePolicy : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected removePolicy(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<removePolicy, string>> _setter = new Dictionary<string, Action<removePolicy, string>>() { }; // _setter
