...
namespace CmisObjectModel.Messaging.Requests
{
   ...
   /// </remarks>
    ...
    public partial class checkOut : RequestBase
    {
      ...
      /// <remarks></remarks>
        protected checkOut(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<checkOut, string>> _setter = new Dictionary<string, Action<checkOut, string>>() { }; // _setter
