...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    public partial class getCheckedOutDocsResponse : Serialization.XmlSerializable
    {
      ...
      /// <remarks></remarks>
        protected getCheckedOutDocsResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<getCheckedOutDocsResponse, string>> _setter = new Dictionary<string, Action<getCheckedOutDocsResponse, string>>() { }; // _setter
