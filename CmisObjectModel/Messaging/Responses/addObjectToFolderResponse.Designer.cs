...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    ...
    public partial class addObjectToFolderResponse : MultiFilingResponse
    {
      ...
      /// <remarks></remarks>
        protected addObjectToFolderResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<addObjectToFolderResponse, string>> _setter = new Dictionary<string, Action<addObjectToFolderResponse, string>>() { }; // _setter
