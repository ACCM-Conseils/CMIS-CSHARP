...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    ...
    public partial class createRelationshipResponse : ObjectManipulationServiceResponse
    {
      ...
      /// <remarks></remarks>
        protected createRelationshipResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<createRelationshipResponse, string>> _setter = new Dictionary<string, Action<createRelationshipResponse, string>>() { }; // _setter
