...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    ...
    public partial class createDocumentFromSourceResponse : ObjectManipulationServiceResponse
    {
      ...
      /// <remarks></remarks>
        protected createDocumentFromSourceResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<createDocumentFromSourceResponse, string>> _setter = new Dictionary<string, Action<createDocumentFromSourceResponse, string>>() { }; // _setter
