...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    public partial class applyPolicyResponse : PolicyManipulationServiceResponse
    {
      ...
      /// <remarks></remarks>
        protected applyPolicyResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<applyPolicyResponse, string>> _setter = new Dictionary<string, Action<applyPolicyResponse, string>>() { }; // _setter
