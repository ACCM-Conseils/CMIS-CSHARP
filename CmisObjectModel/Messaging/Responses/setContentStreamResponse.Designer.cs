...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    ...
    public partial class setContentStreamResponse : ObjectManipulationServiceResponse
    {
      ...
      /// <remarks></remarks>
        protected setContentStreamResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<setContentStreamResponse, string>> _setter = new Dictionary<string, Action<setContentStreamResponse, string>>() { }; // _setter
