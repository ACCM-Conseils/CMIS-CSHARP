...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    public partial class queryResponse : Serialization.XmlSerializable
    {
      ...
      /// <remarks></remarks>
        protected queryResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<queryResponse, string>> _setter = new Dictionary<string, Action<queryResponse, string>>() { }; // _setter
