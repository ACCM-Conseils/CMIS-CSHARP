...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    ...
    public partial class deleteContentStreamResponse : ObjectManipulationServiceResponse
    {
      ...
      /// <remarks></remarks>
        protected deleteContentStreamResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<deleteContentStreamResponse, string>> _setter = new Dictionary<string, Action<deleteContentStreamResponse, string>>() { }; // _setter
