...
{
    public abstract class MultiFilingResponse : Serialization.XmlSerializable
    {

        public MultiFilingResponse()
        {
        }
        /// <summary>
      ...
      /// <remarks></remarks>
        protected MultiFilingResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }
