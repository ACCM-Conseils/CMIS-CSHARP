...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    ...
    public partial class moveObjectResponse : ObjectManipulationServiceResponse
    {
      ...
      /// <remarks></remarks>
        protected moveObjectResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<moveObjectResponse, string>> _setter = new Dictionary<string, Action<moveObjectResponse, string>>() { }; // _setter
