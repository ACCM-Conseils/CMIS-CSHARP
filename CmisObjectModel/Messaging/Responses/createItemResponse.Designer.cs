...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    ...
    public partial class createItemResponse : ObjectManipulationServiceResponse
    {
      ...
      /// <remarks></remarks>
        protected createItemResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<createItemResponse, string>> _setter = new Dictionary<string, Action<createItemResponse, string>>() { }; // _setter
