...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    ...
    public partial class updatePropertiesResponse : ObjectManipulationServiceResponse
    {
      ...
      /// <remarks></remarks>
        protected updatePropertiesResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<updatePropertiesResponse, string>> _setter = new Dictionary<string, Action<updatePropertiesResponse, string>>() { }; // _setter
