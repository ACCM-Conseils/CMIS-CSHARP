...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    public partial class cancelCheckOutResponse : Serialization.XmlSerializable
    {
      ...
      /// <remarks></remarks>
        protected cancelCheckOutResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<cancelCheckOutResponse, string>> _setter = new Dictionary<string, Action<cancelCheckOutResponse, string>>() { }; // _setter
