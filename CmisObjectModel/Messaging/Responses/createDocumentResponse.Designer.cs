...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    ...
    public partial class createDocumentResponse : ObjectManipulationServiceResponse
    {
      ...
      /// <remarks></remarks>
        protected createDocumentResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<createDocumentResponse, string>> _setter = new Dictionary<string, Action<createDocumentResponse, string>>() { }; // _setter
