...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    ...
    public partial class checkInResponse : ObjectManipulationServiceResponse
    {
      ...
      /// <remarks></remarks>
        protected checkInResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<checkInResponse, string>> _setter = new Dictionary<string, Action<checkInResponse, string>>() { }; // _setter
