...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    public partial class getPropertiesOfLatestVersionResponse : Serialization.XmlSerializable
    {
      ...
      /// <remarks></remarks>
        protected getPropertiesOfLatestVersionResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<getPropertiesOfLatestVersionResponse, string>> _setter = new Dictionary<string, Action<getPropertiesOfLatestVersionResponse, string>>() { }; // _setter
