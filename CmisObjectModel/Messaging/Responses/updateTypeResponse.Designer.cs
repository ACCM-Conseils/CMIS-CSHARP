...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    public partial class updateTypeResponse : Serialization.XmlSerializable
    {
      ...
      /// <remarks></remarks>
        protected updateTypeResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<updateTypeResponse, string>> _setter = new Dictionary<string, Action<updateTypeResponse, string>>() { }; // _setter
