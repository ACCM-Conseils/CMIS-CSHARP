...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    public partial class getObjectOfLatestVersionResponse : Serialization.XmlSerializable
    {
      ...
      /// <remarks></remarks>
        protected getObjectOfLatestVersionResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<getObjectOfLatestVersionResponse, string>> _setter = new Dictionary<string, Action<getObjectOfLatestVersionResponse, string>>() { }; // _setter
