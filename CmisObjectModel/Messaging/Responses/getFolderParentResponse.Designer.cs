...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    public partial class getFolderParentResponse : Serialization.XmlSerializable
    {
      ...
      /// <remarks></remarks>
        protected getFolderParentResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<getFolderParentResponse, string>> _setter = new Dictionary<string, Action<getFolderParentResponse, string>>() { }; // _setter
