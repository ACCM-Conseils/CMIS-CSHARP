...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    public partial class removePolicyResponse : PolicyManipulationServiceResponse
    {
      ...
      /// <remarks></remarks>
        protected removePolicyResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<removePolicyResponse, string>> _setter = new Dictionary<string, Action<removePolicyResponse, string>>() { }; // _setter
