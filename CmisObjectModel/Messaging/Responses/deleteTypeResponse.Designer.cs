...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    public partial class deleteTypeResponse : Serialization.XmlSerializable
    {
      ...
      /// <remarks></remarks>
        protected deleteTypeResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<deleteTypeResponse, string>> _setter = new Dictionary<string, Action<deleteTypeResponse, string>>() { }; // _setter
