...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    public partial class getTypeDefinitionResponse : Serialization.XmlSerializable
    {
      ...
      /// <remarks></remarks>
        protected getTypeDefinitionResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<getTypeDefinitionResponse, string>> _setter = new Dictionary<string, Action<getTypeDefinitionResponse, string>>() { }; // _setter
