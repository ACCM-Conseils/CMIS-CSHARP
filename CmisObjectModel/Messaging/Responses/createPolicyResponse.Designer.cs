...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    ...
    public partial class createPolicyResponse : ObjectManipulationServiceResponse
    {
      ...
      /// <remarks></remarks>
        protected createPolicyResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<createPolicyResponse, string>> _setter = new Dictionary<string, Action<createPolicyResponse, string>>() { }; // _setter
