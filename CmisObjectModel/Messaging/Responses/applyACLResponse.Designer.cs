...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    public partial class applyACLResponse : Serialization.XmlSerializable
    {
      ...
      /// <remarks></remarks>
        protected applyACLResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<applyACLResponse, string>> _setter = new Dictionary<string, Action<applyACLResponse, string>>() { }; // _setter
