...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    public partial class deleteObjectResponse : Serialization.XmlSerializable
    {
      ...
      /// <remarks></remarks>
        protected deleteObjectResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<deleteObjectResponse, string>> _setter = new Dictionary<string, Action<deleteObjectResponse, string>>() { }; // _setter
