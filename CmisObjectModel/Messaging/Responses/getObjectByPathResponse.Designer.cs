...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    public partial class getObjectByPathResponse : Serialization.XmlSerializable
    {
      ...
      /// <remarks></remarks>
        protected getObjectByPathResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<getObjectByPathResponse, string>> _setter = new Dictionary<string, Action<getObjectByPathResponse, string>>() { }; // _setter
