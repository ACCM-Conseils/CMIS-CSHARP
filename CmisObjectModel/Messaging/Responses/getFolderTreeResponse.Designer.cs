...
namespace CmisObjectModel.Messaging.Responses
{
   ...
   /// </remarks>
    public partial class getFolderTreeResponse : Serialization.XmlSerializable
    {
      ...
      /// <remarks></remarks>
        protected getFolderTreeResponse(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<getFolderTreeResponse, string>> _setter = new Dictionary<string, Action<getFolderTreeResponse, string>>() { }; // _setter
