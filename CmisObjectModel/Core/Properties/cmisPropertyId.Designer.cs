...
namespace CmisObjectModel.Core.Properties
{
   ...
   /// </remarks>
    public partial class cmisPropertyId : cmisPropertyStringBase
    {
      ...
      /// <remarks></remarks>
        protected cmisPropertyId(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<cmisPropertyId, string>> _setter = new Dictionary<string, Action<cmisPropertyId, string>>() { }; // _setter
