...
namespace CmisObjectModel.Core.Properties
{
   ...
   /// </remarks>
    public partial class cmisPropertyHtml : cmisPropertyStringBase
    {
      ...
      /// <remarks></remarks>
        protected cmisPropertyHtml(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<cmisPropertyHtml, string>> _setter = new Dictionary<string, Action<cmisPropertyHtml, string>>() { }; // _setter
