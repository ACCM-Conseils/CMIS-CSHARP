...
namespace CmisObjectModel.Core.Properties
{
    ...
    public partial class cmisPropertyId
    {
        ...
        public cmisPropertyId(string propertyDefinitionId, string localName, string displayName, string queryName, params string[] values) : base(propertyDefinitionId, localName, displayName, queryName, values)
        {
        }

        #region Constants
        public const string CmisTypeName = "cmis:cmisPropertyId";
        public const string TargetTypeName = "id";
        public const string DefaultElementName = "propertyId";
        #endregion
