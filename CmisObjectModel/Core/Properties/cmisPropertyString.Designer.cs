...
namespace CmisObjectModel.Core.Properties
{
   ...
   /// </remarks>
    public partial class cmisPropertyString : cmisPropertyStringBase
    {
      ...
      /// <remarks></remarks>
        protected cmisPropertyString(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<cmisPropertyString, string>> _setter = new Dictionary<string, Action<cmisPropertyString, string>>() { }; // _setter
