...
namespace CmisObjectModel.Core.Properties
{
    ...
    public partial class cmisPropertyHtml
    {
        ...
        public cmisPropertyHtml(string propertyDefinitionId, string localName, string displayName, string queryName, params string[] values) : base(propertyDefinitionId, localName, displayName, queryName, values)
        {
        }

        #region Constants
        public const string CmisTypeName = "cmis:cmisPropertyHtml";
        public const string TargetTypeName = "html";
        public const string DefaultElementName = "propertyHtml";
        #endregion
