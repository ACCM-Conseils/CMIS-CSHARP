...
namespace CmisObjectModel.Core.Properties
{
   ...
   /// </remarks>
    public partial class cmisPropertyUri : cmisPropertyStringBase
    {
      ...
      /// <remarks></remarks>
        protected cmisPropertyUri(bool? initClassSupported) : base(initClassSupported)
        {
        }

        #region IXmlSerializable
        private static Dictionary<string, Action<cmisPropertyUri, string>> _setter = new Dictionary<string, Action<cmisPropertyUri, string>>() { }; // _setter
