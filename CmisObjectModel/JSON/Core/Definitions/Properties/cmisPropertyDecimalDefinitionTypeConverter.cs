...
{
    [Attributes.JavaScriptConverter(typeof(JSON.Core.Definitions.Properties.cmisPropertyDecimalDefinitionTypeConverter))]
...
namespace CmisObjectModel.JSON.Core.Definitions.Properties
{
    ...
    public partial class cmisPropertyDecimalDefinitionTypeConverter : Generic.cmisPropertyDefinitionTypeConverter<decimal, CmisObjectModel.Core.Choices.cmisChoiceDecimal, CmisObjectModel.Core.Properties.cmisPropertyDecimal, ccdp.cmisPropertyDecimalDefinitionType>
    {

        #region Constructors
        public cmisPropertyDecimalDefinitionTypeConverter() : base(new Serialization.Generic.DefaultObjectResolver<ccdp.cmisPropertyDefinitionType, ccdp.cmisPropertyDecimalDefinitionType>())
        {
        }
        public cmisPropertyDecimalDefinitionTypeConverter(Serialization.Generic.ObjectResolver<ccdp.cmisPropertyDefinitionType> objectResolver) : base(objectResolver)
        {
        }
        #endregion
