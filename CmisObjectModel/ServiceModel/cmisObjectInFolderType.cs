...
{
    public class cmisObjectInFolderType : Messaging.cmisObjectInFolderType, Contracts.IServiceModelObject
    {
        ...
        public new cmisObjectType Object
        {
            get
            {
                return base.Object as cmisObjectType;
            }
            set
            {
                base.Object = value;
        ...
        private string IServiceModelObject_PathSegment
        {
            get
            {
                return _pathSegment;
        ...
        string Contracts.IServiceModelObject.PathSegment { get => IServiceModelObject_PathSegment; }
        ...
        public static implicit operator cmisObjectType(cmisObjectInFolderType value)
        {
